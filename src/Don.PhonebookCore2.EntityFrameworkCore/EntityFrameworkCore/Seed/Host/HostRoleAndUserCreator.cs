...
namespace Don.PhonebookCore2.EntityFrameworkCore.Seed.Host
{
    public class HostRoleAndUserCreator
    {
        private readonly PhonebookCore2DbContext _context;

        public HostRoleAndUserCreator(PhonebookCore2DbContext context)
        {
            _context = context;
        }
        ...
        private void CreateHostRoleAndUsers()
        {
            ...
            if (adminUserForHost == null)
            {
                ...
                var permissions = PermissionFinder
                    .GetAllPermissions(new PhonebookCore2AuthorizationProvider())
